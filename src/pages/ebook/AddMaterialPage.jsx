        ...
        <div className="ebook-material-grid">
          <label><span><b>*</b> Select Material</span>
            <select name="materialTypeId" value={form.materialTypeId} onChange={change} style={inputStyle} required>
              <option value="">{loadingTypes ? 'Loading materials...' : ' '}</option>
          ...
          <label><span>SEO Name</span><input name="seoName" placeholder="SEO Name" value={form.seoName} onChange={change} style={inputStyle} /></label>

          <label><span><b>*</b> Subject Name</span><input name="subjectName" placeholder="Subject Name" value={form.subjectName} onChange={change} style={inputStyle} required /></label>
          <label><span><b>*</b> Save on Phone</span>
            <select name="saveOnPhone" value={form.saveOnPhone} onChange={change} style={inputStyle} required><option value=""> </option><option value="yes">Yes</option><option value="no">No</option></select>
          </label>
          <label><span><b>*</b> Status</span>
            <select name="status" value={form.status} onChange={change} style={inputStyle} required><option value=""> </option><option value="free">Free</option><option value="paid">Paid</option></select>
          </label>
          <label><span><b>*</b> MRP</span><input type="number" min="0" name="mrp" placeholder="MRP" value={form.mrp} onChange={change} style={inputStyle} required /></label>

          <label><span><b>*</b> Price</span><input type="number" min="0" name="price" placeholder="Price" value={form.price} onChange={change} style={inputStyle} required /></label>
          <label><span><b>*</b> Validity (in months)</span><input type="number" min="0" name="validity" placeholder="Validity (in months)" value={form.validity} onChange={change} style={inputStyle} required /></label>
        </div>
